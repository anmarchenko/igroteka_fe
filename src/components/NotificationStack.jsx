...
import defaultPropTypes from '../notificationDefaultPropTypes';
...
const NotificationStack = (props) => (
  <div className="notification-list">
    {props.notifications.map((notification, index) => {
      ...
      // Handle styles
      const barStyle = props.barStyleFactory(
        index,
        notification.barStyle,
        notification
      );
      const actionStyle = props.actionStyleFactory(
        index,
        notification.actionStyle,
        notification
      );
